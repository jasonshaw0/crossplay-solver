...
export default function Solver() {
  ...
  return <>
    <header className="app-header"><div className="brand"><span className="brand-mark" aria-hidden="true"><span>C</span><span>S</span></span><div><h1>Crossplay Solver</h1><span className="tagline">A little clarity for your next move.</span><span className="header-credit">by <a href="https://github.com/jasonshaw0" target="_blank" rel="noreferrer">Jason Shaw</a> · <a href="https://github.com/jasonshaw0/crossplay-solver" target="_blank" rel="noreferrer">GitHub</a></span></div></div><div className="header-actions"><span className="local-badge"><i/>Runs on your device</span><button className="button subtle" onClick={()=>{setDraft(settings);setShowSettings(!showSettings);}} aria-expanded={showSettings}><Icon name="settings"/><span>Settings</span></button></div></header>
